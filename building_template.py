...
class BuildingTemplate:
    def __init__(self, name: str, type: str, cost: int, abilities: list[dict[str, Union[str, list]]], is_national_wonder: bool = False, vp_reward: Optional[int] = None, prereq: Optional[TechTemplate] = None):
        self.name = name
        self.type = type
        self.cost = cost
