...
class UnitTemplate:
    def __init__(self, name: str, building_name: str, metal_cost: int, stone_cost: int, attack: int, health: int, movement: int, range: int, armor: int, abilities: list[list[Union[str, list]]]) -> None:
        self.name = name
